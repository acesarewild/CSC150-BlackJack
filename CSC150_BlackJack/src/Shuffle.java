...
public class Shuffle 
{
	...
	//-----------------------------------------------------
		//  overloaded to shuffle the deck and img paths
		//  @param array
		//  NOTE: This method alters this argument
		//-----------------------------------------------------
		public void shuffleArray(Card[] array, String[] paths)
		{
			for (int i = 0; i < array.length; i++)
			{
				//Randomly choose index j from the remainder of the array
				...
				//Swap paths[i] with paths[j] (i being the current position in the array, j being the random number)
